...
Lurer du på hvordan du kan gjøre nytte av verktøy som f.eks. ChatGPT i skriveprossen, så kan du lese mer om det under [Ofte stilte spørsmål](/ofte-stilte-sporsmal/#hvordan-kan-kunstig-intelligens-f-eks-chatgpt-brukes). Vår veileder for [APA 7h](/referansestiler/apa-7th.html#kunstig-intelligens-f-eks-store-sprakmodeller-som-chatgpt-writesonic-mfl) viser eksempel på hvoran du kan henvise til verktøy som baserer seg på kunstig intelligens i tekst og referanseliste.
