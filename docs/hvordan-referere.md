...
Akademiske tekster har formelle regler for sitering og henvisning som varierer mellom ulike fag, tidsskrifter osv. Eksempelvis finnes det standardiserte [forkortelser](http://sokogskriv.no/kildebruk-og-referanser/hvordan-referere/forkortelser/ "Forkortelser") for bruk i sitering. Nedenfor er det gitt noen eksempler på direkte og indirekte sitater der stilen [Harvard](http://sokogskriv.no/kildebruk-og-referanser/referansestiler/harvard/ "Harvard") er brukt.
...
For flere andre referansetyper se også [Harvardstil](http://sokogskriv.no/kildebruk-og-referanser/referansestiler/harvard/ "Harvard").
