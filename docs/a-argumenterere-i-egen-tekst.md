...
Den enkleste definisjonen av argumentasjon er nettopp "påstand + begrunnelse", og dette vil ofte være tilstrekkelig for å kunne argumentere i en oppgave. Se for eksempel "[redegjør og drøft](http://sokogskriv.no/skriving/struktur/redegjor-og-droft/)", "[argumentasjon i tekst](https://sokogskriv.no/lesing/argumentasjon-i-tekst/)" og filmen "[Saying what you mean](https://youtu.be/OWeAPxlxGnE)["](http://sokogskriv.no/saying-what-you-mean-part-1/) (del 1 & 2). En mer avansert argumentasjonsmodell følger nedenfor.
