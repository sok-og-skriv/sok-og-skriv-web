...
According to the [Large Norwegian Lexicon](https://snl.no), a source is a place where someone can receive information and knowledge on a topic.  In other words sources can be found in many different places: online, books, articles, etc.   
...
## Subject or research article? 

Especially in the medical field it is common to distinguish between subject and research articles, and in many assignments it is expected that the student will be able to make a distinction between the two.  In addition as a student it will be expected that you will know when it is more appropriate to use research article vs an academic article.   


According to [sykepleien.no](https://sykepleien.no) a research article is meant to present new research, while a subject article summarizes knowledge that is already known.  Since a research article is presenting new results that must be verifiable, a research article must be transparent and explain process for how the researchers arrived at their findings.   

When you are trying to determine if it is a subject or research article you are looking at, consider whether the article is presenting new research and findings or is instead summarizing previous research.  It can also be helpful to look at their methods chapter, and see if they have detailed it enough so that you could replicate their research process.   
...
A chronicle is a relatively short article about an enlightening or reasoning character, usually in a newspaper and written by someone who is not included in the newspaper. Chronicles are often used by researchers to bring research-based knowledge into the public. Chronicles, just like encyclopedias and Wikipedia, can be a good place to start to get an overview of a given topic and can help to give you a better understanding of the topic. 
...
## Task: What website do you want to use? 
