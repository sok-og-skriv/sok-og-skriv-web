...
<List 
  ...
  text="Look for this symbol in your word-processor’s menu and select a style. "
/>
...
<List 
  ...
  alt="Text size"
  text="Point size: the most common is 11 for modern fonts such as Calibri, or 12 in a traditional fonts like Times New Roman."
/>
...
<List
  ...
  alt="Align left"
  text="Left-justified text with a floating right margin (not block-justified) provides the best readability."
/>

<List
  image="/images/margins.svg"
  alt="Marger"
  text="Top and bottom margins must be at least 2.5 cm."
/>
...
<List
  ...
  alt="Tabulator knapp"
  text="There should never be more than one space after each word or character. If you need larger spaces (indents), use the tab key."
/>
...
In most academic fields, different source types are included in the same reference list, but in some history-related subjects it can be the case that primary and secondary sources are listed separately. Read more about referencing at '[Different sources](/en/sources-and-referencing/different-sources.html)'.
