...
Forfatter, A. A., Forfatter, B. B. & Forfatter, C. C. (Årstall). Artikkeltittel. _Tidsskrifttittel_, _årgang_(hefte), sidetall.\*Heftenummer skal ikke være med dersom tidsskriftet har gjennomgående paginering. Dersom artikkelen har [DOI-nummer](http://sokogskriv.no/kildebruk-og-referanser/kildevurdering/kvalitative-vurderinger/nettadresser-url#DOI), skal dette være med i referansen. Om DOI mangler, kan lenke til tidsskriftet oppgis isteden.
