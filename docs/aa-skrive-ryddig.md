...
I en teoretisk oppgave er [argumentasjon](?p=2433) og drøfting sentralt. Du kan enten drøfte ideene og begrepene underveis, eller skille ut drøftingen i egne kapitler. Pass uansett på at du ikke redegjør og drøfter i én og samme vending.

I en empirisk oppgave kommer drøftingen etter redegjørelsen, og bringer sammen det som er sagt (bakgrunn, teori, metode og funn). Noen ganger kalles drøfting for diskusjon (fra det engelske ”discussion”). Se mer om diskusjon under [IMRoD-modellen](http://sokogskriv.no/skriving/struktur/imrod-modellen/).
...
**Tips!** Let etter [argumentasjon](?p=2199) og drøfting i andres tekster.
