...
- I henhold til/ifølge Hansen (2020) ...
...
- Med utgangspunkt i teori C (Hansen, 2020) ...

## 3. Stille seg kritisk til tidligere studier

Disse frasene kan du bruke når du skal vise svakheter ved tidligere studier, og dermed underbygge relevansen av ditt eget studium:
...
- Resultatene er basert på data fra (f.eks. 1990), og dt er usikkert om det ville sett likt ut i dag ...
